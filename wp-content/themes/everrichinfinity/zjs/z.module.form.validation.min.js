...
preventPressEnterToSubmit:!1,autoCheckWhenBlur:!0,onlyone:!1}});var u=function(a,c){var d=e(a),b=d.getData("zjsmoduleformvalidationoption");if(b)d.setData("zjsmoduleformvalidationoption",e.extend(b,c));else{var b=e.clone(e.moduleFormValidationOption),f=d.getAttr("data-option","");e.isString(f)&&""!=f.trim()&&(b=e.extend(b,f.jsonDecode()));d.removeAttr("data-option");"undefined"!=typeof c&&(b=e.extend(b,c));b.tips=e.extend(t[b.language],b.tips);b.preventPressEnterToSubmit=!!b.preventPressEnterToSubmit;
b.onlyone=!!b.onlyone;b.onlyone&&(b.autoCheckWhenBlur=!1);d.setData("zjsmoduleformvalidationoption",b);d.addClass("z-form-validation");var h=function(){var a=e.enablehook();e.enablehook(!1);d.find("input[type=text], input[type=email], input[type=password], input.zimagepicker, textarea, .radiogroup, .checkbox, ."+b.customInputClass).each(function(a){var c=e(a);if(!c.hasClass("zui-autosuggestion-input")&&!c.hasClass("zui-datepicker-input")&&!c.getData("zjsmoduleformvalidationinputel",!1)){c.setData("zjsmoduleformvalidationinputel",
!0);a=e('<div class="checktip"><div class="text"></div></div>').addClass("checktip-"+c.getAttr("name")).hide();var g=c.getData("zmoduleautosuggestionwrapel");g?a.insertAfter(g):a.insertAfter(c);c.setData("zjsmoduleformvalidationtipel",a);if(b.autoCheckWhenBlur)c.on("blur, ui.autosuggestion.blur, ui.datepicker.blur",function(){m(this,n(this,b,d),b)});if(c.hasClass("radiogroup"))c.on("click","input[type=radio]",function(){m(c,n(c,b,d),b)});if(c.hasClass("checkbox"))c.on("click","input[type=checkbox]",
function(){m(c,n(c,b,d),b)});c.parent().addClass("z-form-field")}});e.enablehook(a)};h();e.hook({after_insertDOM:function(a){h()}});var k=!1;d.on("submit",function(b){q(a,b)?(this.removeClass("zvalidation-invalid"),k?(k=!1,b.preventDefault()):this.trigger("form.validation.success",{},function(a){a.isDefaultPrevented&&b.preventDefault()})):this.addClass("zvalidation-invalid").trigger("form.validation.failed",{status:d.getData("zjsmoduleformvalidationpassStatus")})});e(window).on("keydown",function(b){13==
b.keyCode()&&(b=e(b.target()).findUp("form"),0<b.count()&&(b=b.getData("zjsmoduleformvalidationoption",!1))&&b.preventPressEnterToSubmit&&(k=!0))});(function(){d.find(".autofocus").focus()}).delay(100)}},q=function(a,c){var d=e(a),b=d.getData("zjsmoduleformvalidationoption");if(b){"moduleEditorOption"in e&&d.find("textarea").editorSave();var f=!0,h,k={};d.find("input,textarea,.radiogroup,.checkbox,."+b.customInputClass).each(function(a){var c=e(a);if((c.is("input[type=text], input[type=email], input[type=password], input.zimagepicker, textarea, .radiogroup, .checkbox, ."+
b.customInputClass)||c.getData("zmoduleautosuggestionwrapel",!1))&&!c.hasClass("zui-autosuggestion-input")&&!c.hasClass("zui-datepicker-input")&&(m(a,h=n(a,b,d),b),a=c.getAttr("name",""),""!=a&&(k[a]=h),!h.pass&&(f=!1,b.onlyone)))return!1});d.setData("zjsmoduleformvalidationpassStatus",k);if(!f){try{"undefined"!=typeof c&&c&&c.preventDefault()}catch(g){}d.find("."+b.errorClass).focus();return!1}return!0}},v=function(a){a=e(a);var c=a.getData("zjsmoduleformvalidationoption",!1);c&&a.find("input,textarea").each(function(a){a=
...
(a=a.getData("zmoduleautosuggestionwrapel",!1))&&a.addClass(d.errorClass)}},n=function(a,c,d){var b=e(a);if(b.hasClass(c.preventClass))return{pass:!0};b.getAttr("id","").trim().toLowerCase();var f=b.getAttr("name","").trim().toLowerCase(),h=b.getAttr("type","").trim().toLowerCase(),k=b.getAttr("class","").trim().toLowerCase(),g=b.getValue("").trim();b.hasClass("radiogroup")&&(g=b.find("input[type=radio]:checked").getValue("").trim());b.hasClass("checkbox")&&(g=b.find("input[type=checkbox]:checked").getValue("").trim());
...
b.getAttr("data-tip-url",""))l="url";else if(0<=f.indexOf("phonenumber")||0<=k.indexOf("phonenumber")||""!=b.getAttr("data-tip-phonenumber",""))l="phonenumber";else if(0<=f.indexOf("number")||0<=k.indexOf("number")||""!=b.getAttr("data-tip-number","")||"number"==h)l="number";else if(0<=f.indexOf("digits")||0<=k.indexOf("digits")||""!=b.getAttr("data-tip-digits",""))l="digits";else if(0<=f.indexOf("date")||""!=b.getAttr("data-tip-date","")||"date"==h)l="date";if(""!=l&&!r[l](g,a))return{pass:!1,type:l}}if(""!=
g){if(0<=f.indexOf("minlength")||0<=k.indexOf("minlength")||""!=b.getAttr("data-tip-minlength",""))l="minlength";if(""!=l&&!r[l](g,a))return{pass:!1,type:l}}if("password"==h&&(0<=f.indexOf("repassword")||0<=k.indexOf("repassword")||""!=b.getAttr("data-tip-repassword",""))&&(f=d.find('input[type="password"]'),1<f.count())){var m=-1;f.each(function(a,c){b.isTheSame(a)&&(m=c)});if(1<=m&&b.getValue("")!=f.item(m-1).getValue())return{pass:!1,type:"repassword"}}d.trigger("form.validation.checking",{element:a,
option:c},function(a){});return{pass:!0}},r={email:function(a,c){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a)},
