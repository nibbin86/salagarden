 ...
 */
	get_header();
?>
	<section id="banner" class="zparallax-section" data-name="banner" data-autoscale="true">
		<div class="section-inside">	
			...
			<div class="form-leftside">
				...
				<p><img src="<?php echo get_template_directory_uri(); ?>/images/home-promotion-img.png" alt="" /></p>
				<div class="form-box">
	...
	<section id="Location" class="zparallax-section" data-name="location" data-autoscale="true" >
		<div class="section-inside">	
			<?php
			...
			<div class="places fadeInRight" data-wow-duration="1.5s">
	...
	<section id="Featured" class="zparallax-section" data-name="featured" data-autoscale="true">
		<div class="section-inside">	
			<div class="title">
	...
	<section id="Services" class="zparallax-section" data-name="services" data-autoscale="true" >
	...
	<section id="Products" class="zparallax-section clearfix" data-name="products" data-autoscale="true" >
		<div class="section-inside">		
			<div class="ztabpanel">
	...
	<section id="contact" class="zparallax-section" data-name="contact" data-autoscale="true" >
		<div class="section-inside">	
			<div class="wrapper container fadeInUp" data-wow-duration="1.5s">
